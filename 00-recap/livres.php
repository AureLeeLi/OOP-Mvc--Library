...
?>
    ...
    <div class="max-w-5xl mx-auto px-3">
        ...
        <p class="bg-[#84d1ae] px-4 py-2 text-[#E7EBC5] rounded-lg m-12"><?=$message;?></p>
        <?php }?>
                ...
                <div class="shadow-lg rounded-lg h-full mx-3">
                    <div class="flex flex-col justify-between h-full">
                        ...
                        <div class="text-center">
                            <a class="bg-gray-900 px-4 py-2 text-white inline-block rounded hover:bg-gray-700 duration-200 mb-4" href="update.php?id=<?= $book['id'];?>">
